function [R, J] = square_boundary_constraint(points,edges_bottom,edges_right,ratio)
    ...
    % index into rows
    col_indA1 = (edges_bottom(:,1)-1)*2+1;
    col_indA2 = (edges_bottom(:,2)-1)*2+1;
    
    col_indB1 = (edges_right(:,1)-1)*2+1;
    col_indB2 = (edges_right(:,2)-1)*2+1;
    ...
    J = sparse(iii,jjj,kkk,1,2*num_points);
    J = full(J);
