function [R, T, L, B] = wavy()
    %%
    
    R_pts = [1 -1; 1.1 -0.8; 1 -0.6; 0.9 -0.4; 1 -0.2; 1.1 0; 1 0.2; 0.9 0.4; 1 0.6; 1.1 0.8; 1 1];
    T_pts = [1 1; 0.8 1.1; 0.6 1; 0.4 0.9; 0.2 1; 0 1.1; -0.2 1; -0.4 0.9; -0.6 1; -0.8 1.1; -1 1];
    L_pts = -R_pts;
    B_pts = -T_pts;
